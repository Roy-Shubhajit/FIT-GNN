...
class GCond:
    ...
    def test_with_val(self, verbose=True):
        ...
        if self.args.save:
            torch.save(adj_syn, f'fitgnn_saved/adj_{args.dataset}_{args.reduction_rate}_{args.seed}.pt')
            torch.save(feat_syn, f'fitgnn_saved/feat_{args.dataset}_{args.reduction_rate}_{args.seed}.pt')
    ...
    def train(self, verbose=True):
        ...
        for it in range(args.epochs+1):
            ...
            eval_epochs = [300, 400, 600, 800, 1000, 1200, 1600, 2000, 3000, 4000, 5000]
            ...
            # if verbose and (it+1) % 50 == 0:
                ...
                #save the res in csv file
                train_acc, test_acc = res.mean(0)
                train_std, test_std = res.std(0)
                with open('results.csv', 'a') as f:
                    writer = csv.writer(f)
                    writer.writerow([args.dataset, 'GCN', args.reduction_rate, args.seed,
