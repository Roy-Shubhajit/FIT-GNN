...
parser.add_argument('--use_max_nodes_size', type=bool, default=1, help='if 1, use max nodes size in the dataset')
parser.add_argument('--pooling', type=str, default='mean')
parser.add_argument('--layer_name', type=str, default='GCNConv', help='layer name')
