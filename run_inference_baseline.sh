...
python inference_baseline.py --experiment random --dataset ogbn-products --num_test_samples 1650 --path_b /hdfs1/Data/Shubhajit/Project/CoPart-GNN/save/node_cls/baseline_new/baseline_ogbn-products_new/ --model_name_b baseline_ogbn-products_random.pt
