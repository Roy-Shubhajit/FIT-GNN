...
do
    ...
    do
        ...
        do
            ...
            do
            output_dir=graph_cls_trial$underscore$dataset$underscore$exp_setup$underscore$coarsening_ratio$underscore$coarsening_method$underscore$extra$underscore$batch_size$underscore$lr
            python main.py --dataset $dataset --output_dir $output_dir --exp_setup $exp_setup --extra_node $extra_node --coarsening_method $coarsening_method --coarsening_ratio $coarsening_ratio --task $task --hidden $hidden --num_layers1 $num_layers1 --num_layers2 $num_layers2 --epochs1 $epochs1 --epochs2 $epochs2 --early_stopping $early_stopping --weight_decay $weight_decay --normalize_features $normalize_features --batch_size $batch_size --lr $lr
            done
        done
    done
...
do
    ...
    do
        ...
        do
            for lr in 0.0001 0.001
            do
            output_dir=graph_cls_trial$underscore$dataset$underscore$exp_setup$underscore$coarsening_ratio$underscore$coarsening_method$underscore$cluster$underscore$batch_size$underscore$lr
            python main.py --dataset $dataset --output_dir $output_dir --exp_setup $exp_setup --extra_node $extra_node --coarsening_method $coarsening_method --coarsening_ratio $coarsening_ratio --task $task --hidden $hidden --num_layers1 $num_layers1 --num_layers2 $num_layers2 --epochs1 $epochs1 --epochs2 $epochs2 --early_stopping $early_stopping --weight_decay $weight_decay --normalize_features $normalize_features --batch_size $batch_size --lr $lr
            done
        done
    done
...
do
    ...
    do
        for lr in 0.0001 0.001
        do
        output_dir=graph_cls_trial$underscore$dataset$underscore$exp_setup$underscore$coarsening_ratio$underscore$coarsening_method$underscore$batch_size$underscore$lr
        python main.py --dataset $dataset --output_dir $output_dir --exp_setup $exp_setup --extra_node $extra_node --coarsening_method $coarsening_method --coarsening_ratio $coarsening_ratio --task $task --hidden $hidden --num_layers1 $num_layers1 --num_layers2 $num_layers2 --epochs1 $epochs1 --epochs2 $epochs2 --early_stopping $early_stopping --weight_decay $weight_decay --normalize_features $normalize_features --batch_size $batch_size --lr $lr
        done
    done
done
