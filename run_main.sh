...
# python main.py --dataset cora --experiment fixed --output_dir $output_dir --exp_setup Gs_train_2_Gs_infer --cluster_node --coarsening_method variation_neighborhoods --coarsening_ratio 0.1 --runs 1 --lr 0.01 --batch_size 1 --epochs2 1
...
# python main.py --dataset chameleon --output_dir $output_dir --exp_setup Gs_train_2_Gs_infer --extra_node --coarsening_method variation_neighborhoods --coarsening_ratio 0.3 --runs 1 --epochs1 1 --epochs2 1

# output_dir="AIDS_Gc_train_2_Gc_infer_0.5_variation_neighborhoods_extra"
# python main.py --dataset AIDS --output_dir $output_dir --exp_setup Gc_train_2_Gc_infer --extra_node --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --epochs1 1 --epochs2 1 --lr 0.01

# output_dir="AIDS_Gc_train_2_Gs_infer_0.5_variation_neighborhoods"
# python main.py --dataset AIDS --output_dir $output_dir --exp_setup Gc_train_2_Gs_infer --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --epochs1 1 --epochs2 1 --lr 0.01

output_dir="ZINC_subset_Gs_train_2_Gs_infer_0.5_variation_neighborhoods_extra"
python main.py --dataset ZINC_subset --output_dir $output_dir --exp_setup Gs_train_2_Gs_infer --extra_node --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --epochs1 1 --epochs2 1 --lr 0.01
...
#                             output_dir=$dataset$underscore$ex/model.ptp_setup$underscore$coarsening_ratio$underscore$coarsening_method$underscore$extra$underscore$lr$underscore$batch_size$underscore$MB
