...
gradient_method="GD"
baseline="baseline"
for dataset in cora chameleon AIDS ZINC_subset
do
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            python main.py --dataset $dataset --output_dir $output_dir --exp_setup $exp_setup --extra_node --coarsening_method $coarsening_method --coarsening_ratio $coarsening_ratio  --normalize_features --lr $lr --runs 1 --loss_reduction $loss_reduction --batch_size $batch_size --gradient_method $gradient_method --epochs1 300 --epochs2 300
                        done
                    done
                done
            done
