...
# output_dir="AIDS_Gc_train_2_Gs_train_0.7_variation_neighborhoods"
# python main.py --dataset AIDS --output_dir $output_dir --exp_setup Gc_train_2_Gs_train --coarsening_method variation_neighborhoods --coarsening_ratio 0.7 --epochs2 1 --epochs1 1
