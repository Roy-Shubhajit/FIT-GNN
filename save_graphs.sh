...
# python save_graphs.py --dataset PROTEINS --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods
# python save_graphs.py --dataset PROTEINS --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods --use_community_detection

# python save_graphs.py --dataset ZINC_subset --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods
# python save_graphs.py --dataset ZINC_subset --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods --use_community_detection

# python save_graphs.py --dataset cora --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods

python save_graphs.py --dataset chameleon --normalize_features --coarsening_ratio 0.5 --coarsening_method variation_neighborhoods