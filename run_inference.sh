...
# python inference.py --dataset ZINC_subset --num_test_samples 20 --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gs_train_2_Gs_infer --extra_node --path_gs /hdfs1/Data/weather/Kishan2/FIT-GNN/save/graph_reg/ZINC_subset_Gc_train_2_Gs_infer_0.5_variation_neighborhoods_extra/ --model_name_gs model.pt --baseline --path_b save/graph_reg/baseline/ --model_name_b baseline_ZINC_subset.pt
...
# python inference.py --dataset chameleon --num_test_samples 20 --coarsening_method variation_neighborhoods --coarsening_ratio 0.3 --exp_setup Gs_train_2_Gs_infer --extra_node --path_gs /hdfs1/Data/weather/Kishan2/FIT-GNN/save/node_reg/chameleon_Gs_train_2_Gs_infer_0.3_variation_neighborhoods_extra_0.01_128_GD/ --model_name_gs model.pt --baseline --path_b save/node_reg/baseline/ --model_name_b baseline_chameleon.pt

# python inference.py --experiment random --dataset ogbn-products --num_test_samples 1650000000 --coarsening_method variation_neighborhoods --coarsening_ratio 0.3 --exp_setup Gs_train_2_Gc_infer --cluster_node --path_gs /hdfs1/Data/Shubhajit/Project/CoPart-GNN/save/node_cls/ogbn_products_exp_6/ --model_name_gs model.pt

# python inference.py --dataset AIDS --num_test_samples 20 --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gc_train_2_Gs_infer --path_gs /hdfs1/Data/weather/Kishan2/FIT-GNN/save/graph_cls/AIDS_Gs_train_2_Gs_infer_0.5_variation_neighborhoods_extra/ --model_name_gs model.pt --baseline --path_b save/graph_cls/baseline/ --model_name_b baseline_AIDS.pt