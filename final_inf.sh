...
python inference.py --dataset PROTEINS --num_test_samples 20 --baseline True --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gs_train_2_Gs_infer --cluster_node True --batch_size 128 --lr 0.0001 --path_b final_models/ --model_name_b baseline_PROTEINS_batch_128_lr_0.0001.pt --path_gs final_models/model_folder/PROTEINS_Gs_train_2_Gs_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_gs model.pt
python inference.py --dataset AIDS --num_test_samples 20 --baseline True --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gc_train_2_Gc_infer --cluster_node True --batch_size 128 --lr 0.0001 --path_b final_models/NEWAIDS_Gc_train_2_Gc_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_b model.pt --path_gs final_models/NEWAIDS_Gc_train_2_Gc_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_gs model.pt
python inference.py --dataset PROTEINS --num_test_samples 20 --baseline True --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gs_train_2_Gs_infer --cluster_node True --batch_size 128 --lr 0.0001 --path_b final_models/ --model_name_b baseline_PROTEINS_batch_128_lr_0.0001.pt --path_gs final_models/model_folder/PROTEINS_Gs_train_2_Gs_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_gs model.pt
python inference.py --dataset AIDS --num_test_samples 20 --baseline True --coarsening_method variation_neighborhoods --coarsening_ratio 0.5 --exp_setup Gc_train_2_Gc_infer --cluster_node True --batch_size 128 --lr 0.0001 --path_b final_models/NEWAIDS_Gc_train_2_Gc_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_b model.pt --path_gs final_models/NEWAIDS_Gc_train_2_Gc_infer_0.3_variation_neighborhoods_cluster_128_0.0001/ --model_name_gs model.pt
